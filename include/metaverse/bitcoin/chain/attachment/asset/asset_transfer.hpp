...
constexpr size_t ASSET_TRANSFER_SYMBOL_FIX_SIZE = 64;
constexpr size_t ASSET_TRANSFER_QUANTITY_FIX_SIZE = 8;

constexpr size_t ASSET_TRANSFER_FIX_SIZE = ASSET_TRANSFER_SYMBOL_FIX_SIZE + ASSET_TRANSFER_QUANTITY_FIX_SIZE;
