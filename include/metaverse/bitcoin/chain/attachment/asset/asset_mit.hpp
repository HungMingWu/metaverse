...
constexpr size_t ASSET_MIT_SYMBOL_FIX_SIZE  = 64;
constexpr size_t ASSET_MIT_ADDRESS_FIX_SIZE = 64;
constexpr size_t ASSET_MIT_CONTENT_FIX_SIZE = 256;
constexpr size_t ASSET_MIT_STATUS_FIX_SIZE  = 1;

constexpr size_t ASSET_MIT_FIX_SIZE = (ASSET_MIT_SYMBOL_FIX_SIZE
        + ASSET_MIT_ADDRESS_FIX_SIZE + ASSET_MIT_CONTENT_FIX_SIZE
        + ASSET_MIT_STATUS_FIX_SIZE);

constexpr size_t ASSET_MIT_TRANSFER_FIX_SIZE = (
            ASSET_MIT_FIX_SIZE - ASSET_MIT_CONTENT_FIX_SIZE);

// output_height; timestamp; to_did; mit;
constexpr size_t ASSET_MIT_INFO_FIX_SIZE = 4 + 4 + 64 + ASSET_MIT_TRANSFER_FIX_SIZE;
