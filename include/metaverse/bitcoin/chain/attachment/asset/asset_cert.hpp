...
constexpr size_t ASSET_CERT_SYMBOL_FIX_SIZE = 64;
constexpr size_t ASSET_CERT_OWNER_FIX_SIZE = 64;
constexpr size_t ASSET_CERT_ADDRESS_FIX_SIZE = 64;
constexpr size_t ASSET_CERT_TYPE_FIX_SIZE = 4;
constexpr size_t ASSET_CERT_STATUS_FIX_SIZE = 1;

constexpr size_t ASSET_CERT_FIX_SIZE = (ASSET_CERT_SYMBOL_FIX_SIZE
